...
from src.quantum.true_random.dice_throwing.exception.QiskryptQuantumDiceThrowingException \
...
class QiskryptQuantumDiceThrowing:
    ...
    def get_dice_throwing_outcome_bits(self) -> str:
        """
        Return the classical outcome (i.e., the observation) from the Dice Throwing,
        through the execution of the respective Qiskrypt's Quantum Circuit,
        in binary digits format (i.e., a sequence of bits).

        :return self.dice_throwing_outcome_bits: the classical outcome (i.e., the observation) from the Dice Throwing,
                                                 through the execution of the respective Qiskrypt's Quantum Circuit,
                                                 in binary digits format (i.e., a sequence of bits).
        """
    ...
    def get_dice_throwing_outcome_bits_as_int_base_2(self) -> int:
        ...
        :return int(self.dice_throwing_outcome_bits, base=2): the classical outcome (i.e., the observation) from
    ...
    def throw_dice(self):
        ...
        Quantum Superposition all over their possible classical results/outcomes (observations),
        storing, the final classical result/outcome from the observation of it, in a sequence of bits.
        """
