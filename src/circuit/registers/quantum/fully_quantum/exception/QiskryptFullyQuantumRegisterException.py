...
class QiskryptNotFullyQuantumRegisterError(Exception):
    """
    Object Class of the Not a Fully-Quantum Register Error for
    the Qiskrypt's Fully-Quantum Register.
    """

    def __init__(self, message=MESSAGE_NOT_FULLY_QUANTUM_REGISTER_EXCEPTION):
        """
        Constructor for the Not a Fully-Quantum Register Error for
        the Qiskrypt's Fully-Quantum Register.
        :param message: the custom message for the Not a Fully-Quantum Register Error for
                        the Qiskrypt's Fully-Quantum Register.
        """
