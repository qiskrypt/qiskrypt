...
POSSIBLE_QUANTUM_CRYPTOGRAPHIC_PRIMITIVES_CARDINALITIES = ["BIPARTITE", "MULTIPARTITE"]
"""
The available Quantum Cryptographic Primitive cardinalities for
the Qiskrypt's Quantum Cryptographic Primitive.
"""

POSSIBLE_QUANTUM_CRYPTOGRAPHIC_PRIMITIVES_SCENARIOS = ["NOISELESS", "NOISY"]
"""
The available Quantum Cryptographic Primitive scenarios for
the Qiskrypt's Quantum Cryptographic Primitive.
"""

POSSIBLE_QUANTUM_CRYPTOGRAPHIC_PRIMITIVES_TYPES = ["CRYPTOCURRENCY", "KEY_EXCHANGE", "STEGANOGRAPHY"]
"""
...
class QiskryptQuantumCryptographicPrimitive:
    ...
    def __init__(self, name: str, quantum_cryptographic_primitive_cardinality: str,
        ...
        if quantum_cryptographic_primitive_cardinality in POSSIBLE_QUANTUM_CRYPTOGRAPHIC_PRIMITIVES_CARDINALITIES:
            """
            If the given cardinality of the Qiskrypt's Quantum Cryptographic Primitive is valid.
            """

            if quantum_cryptographic_primitive_scenario in POSSIBLE_QUANTUM_CRYPTOGRAPHIC_PRIMITIVES_SCENARIOS:
                """
                If the given scenario of the Qiskrypt's Quantum Cryptographic Primitive is valid.
                """

                if quantum_cryptographic_primitive_type in POSSIBLE_QUANTUM_CRYPTOGRAPHIC_PRIMITIVES_TYPES:
                    """
