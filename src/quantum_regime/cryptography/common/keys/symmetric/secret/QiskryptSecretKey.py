...
class QiskryptSecretKey(QiskryptSymmetricKey):
    """
    Object class for the Qiskrypt's Secret Key.
    """

    def __init__(self, bits: str, owner_uuid: UUID, key_type: str, final: bool):
        """
        Constructor of the Qiskrypt's Secret Key.
        ...
        super().__init__(bits, owner_uuid, POSSIBLE_KEY_PRIVACY_LEVELS[0], key_type, final)
        """
