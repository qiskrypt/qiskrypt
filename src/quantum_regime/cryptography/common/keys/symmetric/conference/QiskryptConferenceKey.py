...
from src.quantum_regime.cryptography.common.keys.symmetric.QiskryptSymmetricKey \
    import QiskryptSymmetricKey
"""
Import the Qiskrypt's Symmetric Key.
"""
...
class QiskryptConferenceKey(QiskryptSymmetricKey):
    """
    Object class for the Qiskrypt's Conference Key.
    """

    def __init__(self, bits: str, owner_uuid: UUID, key_type: str, final: bool):
        """
        Constructor of the Qiskrypt's Conference Key.
        ...
        super().__init__(bits, owner_uuid, POSSIBLE_KEY_PRIVACY_LEVELS[1], key_type, final)
        """
        Call of the constructor of the super-class Qiskrypt's Symmetric Key.
        """
