...
class QiskryptSymmetricKey(QiskryptKey):
    """
    Object class for the Qiskrypt's Symmetric Key.
    """

    def __init__(self, bits: str, owner_uuid: UUID,
                 key_privacy_level: str, key_type: str, final: bool):
        """
        Constructor of the Qiskrypt's Symmetric Key.
        ...
        super().__init__(bits, owner_uuid, POSSIBLE_KEY_CATEGORIES[0],
