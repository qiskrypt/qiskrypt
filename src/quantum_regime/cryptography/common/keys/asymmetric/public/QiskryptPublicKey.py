...
class QiskryptPublicKey(QiskryptAsymmetricKey):
    """
    Object class for the Qiskrypt's Public Key.
    """
    ...
    def __init__(self, bits: str, owner_uuid: UUID, key_type: str, final: bool):
        ...
        super().__init__(bits, owner_uuid, POSSIBLE_KEY_PRIVACY_LEVELS[3], key_type, final)
        """
