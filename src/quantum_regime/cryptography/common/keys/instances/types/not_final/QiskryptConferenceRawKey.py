...
class QiskryptConferenceRawKey(QiskryptConferenceKey):
    """
    Object class for the Qiskrypt's Conference Raw Key.
    """

    def __init__(self, bits: str, owner_uuid: UUID):
        """
        Constructor of the Qiskrypt's Conference Raw Key.
