...
from src.quantum_regime.cryptography.common.keys.instances.QiskryptConferenceKey \
...
class QiskryptConferenceSiftedKey(QiskryptConferenceKey):
    """
    Object class for the Qiskrypt's Conference Sifted Key.
    """

    def __init__(self, bits: str, owner_uuid: UUID):
        """
        Constructor of the Qiskrypt's Conference Sifted Key.
