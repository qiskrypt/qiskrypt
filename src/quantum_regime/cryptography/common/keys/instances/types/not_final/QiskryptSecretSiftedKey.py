...
from src.quantum_regime.cryptography.common.keys.instances.QiskryptSecretKey \
...
class QiskryptSecretSiftedKey(QiskryptSecretKey):
    """
    Object class for the Qiskrypt's Secret Sifted Key.
    """

    def __init__(self, bits: str, owner_uuid: UUID):
        """
        Constructor of the Qiskrypt's Secret Sifted Key.
        ...
        super().__init__(bits, owner_uuid, POSSIBLE_KEY_TYPES[1], False)
        """
        Call of the constructor of the super-class Qiskrypt's Secret Key.
        """
