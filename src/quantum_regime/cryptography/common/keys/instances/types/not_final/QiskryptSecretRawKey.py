...
class QiskryptSecretRawKey(QiskryptSecretKey):
    """
    Object class for the Qiskrypt's Secret Raw Key.
    """

    def __init__(self, bits: str, owner_uuid: UUID):
        """
        Constructor of the Qiskrypt's Secret Raw Key.
        ...
        super().__init__(bits, owner_uuid, POSSIBLE_KEY_TYPES[0], False)
        """
