...
from src.quantum_regime.cryptography.key_exchange\
    ...
    import QiskryptSemiQuantumConferenceKeyAgreement
"""
Import the Qiskrypt's Semi-Quantum Conference Key Agreement (SQCKA).
"""
...
from src.quantum_regime.cryptography.key_exchange\
    .semi_quantum_conference_key_agreement.QiskryptSemiQuantumConferenceKeyAgreement \
    import POSSIBLE_SEMI_QUANTUM_CONFERENCE_KEY_AGREEMENT_TYPES
"""
Import the available Semi-Quantum Conference Key Agreement (SQCKA) types for
...
DV_BKMPS22_PROTOCOL_NAME = "DV (DISCRETE VARIABLES) BKMPS22 PROTOCOL"
"""
The name of the DV (Discrete Variables) BKMPS22 Protocol.
"""

DV_BKMPS22_PROTOCOL_DEFAULT_NUM_ROUNDS_FOR_QUANTUM_TRANSMISSION_PHASE = 1024
"""
The default number of rounds for the Quantum Transmission Phase of
the Qiskrypt's DV (Discrete Variable) BKMPS22 Protocol.
"""

DV_BKMPS22_PROTOCOL_DEFAULT_FACTOR_FOR_NUM_ROUNDS_OF_PARAMETER_ESTIMATION_SAMPLE = 0.5
"""
...
class QiskryptDVBKMPS22Protocol(QiskryptSemiQuantumConferenceKeyAgreement):
    """
    Object class for the Qiskrypt's DV (Discrete Variables) BKMPS22 Protocol.

    Reference(s):
    1) Quantum cryptography: Public key distribution and coin tossing:
       - Authors: Ruben Barreiro, Walter Krawec, Paulo Mateus, Nikola Paunkovic and Andre Souto
       - Year: 2022
    ...
    def __init__(self, primitive_scenario: str,
                 ...
                 verbose=True):
        """
        Constructor of the Qiskrypt's DV (Discrete Variables) BKMPS22 Protocol.
        ...
        if primitive_scenario in POSSIBLE_QUANTUM_CRYPTOGRAPHIC_PRIMITIVE_SCENARIOS:
            ...
            super().__init__(DV_BKMPS22_PROTOCOL_NAME,
                             ...
                             POSSIBLE_SEMI_QUANTUM_CONFERENCE_KEY_AGREEMENT_TYPES[1], verbose)
            """
            Call of the constructor of the super-class Qiskrypt's Semi-Quantum Conference Key Agreement (SQCKA).
            """

            self.quantum_bit_error_rates = \
                [0.0] * len(POSSIBLE_DV_BKMPS22_PROTOCOL_ROUND_TYPES_QUANTUM_TRANSMISSION_PHASE)
            """
    ...
    def get_quantum_transmission_phase_rounds_not_discarded_from_parameter_estimation(self) -> list:
        """
        Return the list of the rounds for the Quantum Transmission Phase of
        the Qiskrypt's Semi-Quantum Conference Key Agreement (SQCKA) not discarded from the Parameter Estimation.
