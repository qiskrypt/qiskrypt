...
class QiskryptNoiselessDVBB84ProtocolWithNoEavesdroppingQuantumTransmissionPhaseRound \
    ...
    def is_round_basis_sender_choice_made(self) -> bool:
        ...
        :return super().is_round_basis_sender_choice_made(): if the basis choice made by the sender in
        ...
        the Qiskrypt's DV (Discrete Variables) BB84 Protocol Round is already set.
        """
        return super().is_round_basis_sender_choice_made()
    ...
    def set_round_basis_sender_choice(self, round_basis_sender_choice: str) -> None:
        ...
        the Qiskrypt's DV (Discrete Variables) BB84 Protocol Round, if it is not set yet.
        """
        super().set_round_basis_sender_choice(round_basis_sender_choice)
    ...
    def get_round_basis_sender_choice(self) -> str:
        ...
        :return super().get_round_basis_sender_choice(): the basis choice made by the sender in
                                                         the Qiskrypt's DV (Discrete Variables) BB84 Protocol Round,
        ...
        the Qiskrypt's DV (Discrete Variables) BB84 Protocol Round, if it is already set.
        """
        return super().get_round_basis_sender_choice()
    ...
    def is_round_basis_receiver_choice_made(self) -> bool:
        ...
        the Qiskrypt's DV (Discrete Variables) BB84 Protocol Round is already set.
        """
        return super().is_round_basis_receiver_choice_made()
    ...
    def set_round_basis_receiver_choice(self, round_basis_receiver_choice: str) -> None:
        ...
        the Qiskrypt's DV (Discrete Variables) BB84 Protocol Round, if it is not set yet.
        """
        super().set_round_basis_receiver_choice(round_basis_receiver_choice)
    ...
    def get_round_basis_receiver_choice(self) -> str:
        ...
        :return super().get_round_basis_receiver_choice(): the basis choice made by the receiver in
                                                           the Qiskrypt's DV (Discrete Variables) BB84 Protocol Round,
                                                           if it is already set.
        """
        ...
        the Qiskrypt's DV (Discrete Variables) BB84 Protocol Round, if it is already set.
        """
        return super().get_round_basis_receiver_choice()
