...
class QiskryptFiberOpticMedium(QiskryptMedium):
    """
    Object class for the Qiskrypt's Fiber Optic Medium.
    """

    def __init__(self, num: int, name: str,
                 medium_length_in_kms: float):
        """
        Constructor of the Qiskrypt's Fiber Optic Medium.
        ...
        super().__init__(num, name, POSSIBLE_MEDIUM_TYPES[0], medium_length_in_kms)
        """
