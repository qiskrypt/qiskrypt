...
MIN_ALTITUDE_HEO_SATELLITE_STATION_IN_KMS = 35786
"""
The minimum altitude in KMs (Kilometers) for a
Qiskrypt's HEO (High-Earth Orbit) Satellite Station.
"""


class QiskryptHEOSatelliteStationEndpoint(QiskryptSatelliteStationEndpoint):
    """
    Object class for the Qiskrypt's HEO (High-Earth Orbit) Satellite Station Endpoint.
    """

    def __init__(self, num: int, name: str, context: str,
                 longitude: str, latitude: str, altitude_in_kms: str):
        """
        Constructor of the Qiskrypt's HEO (High-Earth Orbit) Satellite Station Endpoint.
        ...
        if float(altitude_in_kms) > MIN_ALTITUDE_HEO_SATELLITE_STATION_IN_KMS:
            ...
            super().__init__(num, name, context,
                             ...
                             POSSIBLE_SATELLITE_STATION_ORBIT_TYPES[2])
            """
