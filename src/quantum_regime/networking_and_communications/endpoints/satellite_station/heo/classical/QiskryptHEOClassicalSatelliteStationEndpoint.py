...
class QiskryptHEOClassicalSatelliteStationEndpoint(QiskryptHEOSatelliteStationEndpoint):
    """
    Object class for the Qiskrypt's HEO (High-Earth Orbit) Classical Satellite Station Endpoint.
    """

    def __init__(self, num: int, name: str,
                 longitude: str, latitude: str, altitude_in_kms: str):
        """
        Constructor of the Qiskrypt's HEO (High-Earth Orbit) Classical Satellite Station Endpoint.
