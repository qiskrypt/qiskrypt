...
class QiskryptHEOQuantumSatelliteStationEndpoint(QiskryptHEOSatelliteStationEndpoint):
    """
    Object class for the Qiskrypt's HEO (High-Earth Orbit) Quantum Satellite Station Endpoint.
    """

    def __init__(self, num: int, name: str,
                 longitude: str, latitude: str, altitude_in_kms: str):
        """
        Constructor of the Qiskrypt's HEO (High-Earth Orbit) Quantum Satellite Station Endpoint.
