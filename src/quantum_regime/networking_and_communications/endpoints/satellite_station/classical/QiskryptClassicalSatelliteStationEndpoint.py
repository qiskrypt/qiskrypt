...
class QiskryptClassicalSatelliteStationEndpoint(QiskryptSatelliteStationEndpoint):
    """
    Object class for the Qiskrypt's Classical Satellite Station Endpoint.
    """

    def __init__(self, num: int, name: str,
                 longitude: str, latitude: str, altitude: str):
        """
        Constructor of the Qiskrypt's Classical Satellite Station Endpoint.
