...
class QiskryptFullyQuantumSatelliteStationEndpoint(QiskryptSatelliteStationEndpoint):
    """
    Object class for the Qiskrypt's Fully-Quantum Satellite Station Endpoint.
    """

    def __init__(self, num: int, name: str,
                 longitude: str, latitude: str, altitude: str):
        """
        Constructor of the Qiskrypt's Fully-Quantum Satellite Station Endpoint.
    ...
    def get_altitude_in_kms(self) -> str:
        ...
        :return super().get_altitude(): the altitude in KMs (Kilometers) of the Qiskrypt's Endpoint.
        """
