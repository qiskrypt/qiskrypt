...
class QiskryptLEOFullyQuantumSatelliteStationEndpoint(QiskryptLEOSatelliteStationEndpoint):
    """
    Object class for the Qiskrypt's LEO (Low-Earth Orbit) Fully-Quantum Satellite Station Endpoint.
    """

    def __init__(self, num: int, name: str,
                 longitude: str, latitude: str, altitude_in_kms: str):
        """
        Constructor of the Qiskrypt's LEO (Low-Earth Orbit) Fully-Quantum Satellite Station Endpoint.
        ...
        """
        Call of the constructor of the super-class Qiskrypt's LEO (Low-Earth Orbit) Satellite Station Endpoint.
        """
