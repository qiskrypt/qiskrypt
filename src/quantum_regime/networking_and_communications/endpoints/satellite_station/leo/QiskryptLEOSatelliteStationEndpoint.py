...
class QiskryptLEOSatelliteStationEndpoint(QiskryptSatelliteStationEndpoint):
    """
    Object class for the Qiskrypt's LEO (Low-Earth Orbit) Satellite Station Endpoint.
    """

    def __init__(self, num: int, name: str, context: str,
                 longitude: str, latitude: str, altitude_in_kms: str):
        """
        Constructor of the Qiskrypt's LEO (Low-Earth Orbit) Satellite Station Endpoint.
        ...
        if float(altitude_in_kms) < MAX_ALTITUDE_LEO_SATELLITE_STATION_IN_KMS:
            ...
            super().__init__(num, name, context,
                             ...
                             POSSIBLE_SATELLITE_STATION_ORBIT_TYPES[0])
            """
