...
class QiskryptMEOFullyQuantumSatelliteStationEndpoint(QiskryptMEOSatelliteStationEndpoint):
    """
    Object class for the Qiskrypt's MEO (Medium-Earth Orbit) Fully-Quantum Satellite Station Endpoint.
    """

    def __init__(self, num: int, name: str,
                 longitude: str, latitude: str, altitude_in_kms: str):
        """
        Constructor of the Qiskrypt's MEO (Medium-Earth Orbit) Fully-Quantum Satellite Station Endpoint.
        ...
        super().__init__(num, name, POSSIBLE_ENDPOINT_CONTEXTS[1],
                         longitude, latitude, altitude_in_kms)
        """
        Call of the constructor of the super-class Qiskrypt's MEO (Medium-Earth Orbit) Satellite Station Endpoint.
        """
