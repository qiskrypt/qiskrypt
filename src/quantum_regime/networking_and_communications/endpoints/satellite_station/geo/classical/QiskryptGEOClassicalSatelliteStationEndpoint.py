...
class QiskryptGEOClassicalSatelliteStationEndpoint(QiskryptGEOSatelliteStationEndpoint):
    """
    Object class for the Qiskrypt's GEO (GEostationary Orbit) Classical Satellite Station Endpoint.
    """

    def __init__(self, num: int, name: str,
                 longitude: str, latitude: str, altitude_in_kms: str):
        """
        Constructor of the Qiskrypt's GEO (GEostationary Orbit) Classical Satellite Station Endpoint.
