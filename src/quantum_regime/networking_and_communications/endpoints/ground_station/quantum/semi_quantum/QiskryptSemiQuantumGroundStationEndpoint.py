...
class QiskryptSemiQuantumGroundStationEndpoint(QiskryptGroundStationEndpoint):
    """
    Object class for the Qiskrypt's Semi-Quantum Ground Station Endpoint.
    """

    def __init__(self, num: int, name: str,
                 longitude: str, latitude: str, altitude_in_kms: str):
        """
        Constructor of the Qiskrypt's Semi-Quantum Ground Station Endpoint.
