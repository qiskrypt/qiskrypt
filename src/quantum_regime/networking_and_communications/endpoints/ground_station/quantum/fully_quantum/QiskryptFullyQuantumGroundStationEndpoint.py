...
class QiskryptFullyQuantumGroundStationEndpoint(QiskryptGroundStationEndpoint):
    """
    Object class for the Qiskrypt's Fully-Quantum Ground Station Endpoint.
    """

    def __init__(self, num: int, name: str,
                 longitude: str, latitude: str, altitude_in_kms: str):
        """
        Constructor of the Qiskrypt's Fully-Quantum Ground Station Endpoint.
        ...
        """
        Call of the constructor of the super-class Qiskrypt's Ground Station Endpoint.
        """
