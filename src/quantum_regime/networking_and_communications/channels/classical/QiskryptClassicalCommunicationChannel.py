...
class QiskryptClassicalCommunicationChannel(QiskryptCommunicationChannel):
    """
    Object class for the Qiskrypt's Classical Communication Channel.
    """
    ...
    def __init__(self, num: int, name: str, scenario: str,
        ...
        super().__init__(num, name, POSSIBLE_COMMUNICATION_CHANNEL_CONTEXTS[1],
