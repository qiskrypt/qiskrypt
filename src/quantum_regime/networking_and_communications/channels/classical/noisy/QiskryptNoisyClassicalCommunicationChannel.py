...
class QiskryptNoisyClassicalCommunicationChannel(QiskryptClassicalCommunicationChannel):
    """
    Object class for the Qiskrypt's Noisy Classical Communication Channel.
    """

    def __init__(self, num: int, name: str, channel_type: str, directions: list):
        """
        Constructor of the Qiskrypt's Noisy Classical Communication Channel.
