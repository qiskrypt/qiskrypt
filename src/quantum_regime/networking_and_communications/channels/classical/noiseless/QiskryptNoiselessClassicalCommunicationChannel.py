...
class QiskryptNoiselessClassicalCommunicationChannel(QiskryptClassicalCommunicationChannel):
    """
    Object class for the Qiskrypt's Noiseless Classical Communication Channel.
    """

    def __init__(self, num: int, name: str, channel_type: str, directions: list):
        """
        Constructor of the Qiskrypt's Noiseless Classical Communication Channel.
        ...
        super().__init__(num, name, POSSIBLE_COMMUNICATION_CHANNEL_SCENARIOS[0],
                         channel_type, directions)
        """
        Call of the constructor of the super-class Qiskrypt's Classical Communication Channel.
        """
