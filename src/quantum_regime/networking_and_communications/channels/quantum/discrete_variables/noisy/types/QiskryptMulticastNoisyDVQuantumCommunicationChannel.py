...
from src.quantum_regime.networking_and_communications.channels\
    .quantum.discrete_variables.noisy.QiskryptNoisyDVQuantumCommunicationChannel \
    import QiskryptNoisyDVQuantumCommunicationChannel
"""
Import the Qiskrypt's Noisy DV (Discrete Variables) Quantum Communication Channel.
"""
...
class QiskryptMulticastNoisyDVQuantumCommunicationChannel(QiskryptNoisyDVQuantumCommunicationChannel):
    """
    Object class for the Qiskrypt's Multicast (One-to-Many) Noisy
    DV (Discrete Variables) Quantum Communication Channel.
    """

    def __init__(self, num: int, name: str, directions: list):
        """
        Constructor of the Qiskrypt's Multicast (One-to-Many) Noisy
        DV (Discrete Variables) Quantum Communication Channel.
        ...
        super().__init__(num, name, POSSIBLE_COMMUNICATION_CHANNEL_TYPES[2], directions)
        """
