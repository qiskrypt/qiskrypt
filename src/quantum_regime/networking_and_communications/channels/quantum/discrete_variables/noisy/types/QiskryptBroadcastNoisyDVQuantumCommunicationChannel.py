...
class QiskryptBroadcastNoisyDVQuantumCommunicationChannel(QiskryptNoisyDVQuantumCommunicationChannel):
    """
    Object class for the Qiskrypt's Broadcast (One-to-All) Noisy
    DV (Discrete Variables) Quantum Communication Channel.
    """

    def __init__(self, num: int, name: str, directions: list):
        """
        Constructor of the Qiskrypt's Broadcast (One-to-All) Noisy
        DV (Discrete Variables) Quantum Communication Channel.
        ...
        super().__init__(num, name, POSSIBLE_COMMUNICATION_CHANNEL_TYPES[1], directions)
        """
