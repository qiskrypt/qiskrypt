...
"""
Import the Qiskrypt's DV (Discrete Variables) Quantum Communication Channel.
"""
...
class QiskryptNoisyDVQuantumCommunicationChannel(QiskryptDVQuantumCommunicationChannel):
    """
    Object class for the Qiskrypt's Noisy DV (Discrete Variables)
    Quantum Communication Channel.
    """

    def __init__(self, num: int, name: str, channel_type: str, directions: list):
        """
        Constructor of the Qiskrypt's Noisy DV (Discrete Variables)
        Quantum Communication Channel.
        ...
        super().__init__(num, name, POSSIBLE_COMMUNICATION_CHANNEL_SCENARIOS[1],
                         channel_type, directions)
        """
        Call of the constructor of the super-class Qiskrypt's DV (Discrete Variables)
        Quantum Communication Channel.
        """
