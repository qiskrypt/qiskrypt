...
"""
Import the available contexts for the Qiskrypt's Communication Channel.
"""
...
POSSIBLE_QUANTUM_COMMUNICATION_CHANNEL_SIGNAL_VARIABLE_TYPES = ["DISCRETE (DV)", "CONTINUOUS (CV)"]
"""
...
class QiskryptQuantumCommunicationChannel(QiskryptCommunicationChannel):
    ...
    def __init__(self, num: int, name: str, scenario: str,
                 channel_type: str, directions: list, signal_variable_type: str):
        """
        ...
        :param signal_variable_type: the signal variable type of the Qiskrypt's Communication Channel.
        """

        super().__init__(num, name, POSSIBLE_COMMUNICATION_CHANNEL_CONTEXTS[0],
                         scenario, channel_type, directions)
        """
        Call of the constructor of the super-class Qiskrypt's Communication Channel.
        """

        self.signal_variable_type = signal_variable_type
        """
