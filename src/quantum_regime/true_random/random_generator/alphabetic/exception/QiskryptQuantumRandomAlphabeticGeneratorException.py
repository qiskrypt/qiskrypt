...
MESSAGE_NO_CHARACTERS_GROUP_CHOSEN_EXCEPTION = "No Characters Group Chosen Error: " \
                                               "No characters group chosen for the Quantum Random Alphabetic Generator!!!\n"
"""
...
class QiskryptQuantumRandomAlphabeticGeneratorNoCharactersGroupChosenError(Exception):
    """
