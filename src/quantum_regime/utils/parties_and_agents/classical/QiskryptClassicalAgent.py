...
class QiskryptClassicalAgent(QiskryptAgent):
    """
    Object class for the Qiskrypt's Classical Agent.
    """

    def __init__(self, classical_agent_num: int, classical_agent_name: str):
        """
        Constructor of the Qiskrypt's Classical Agent.

        :param classical_agent_num: the number of the Qiskrypt's Classical Agent.
        :param classical_agent_name: the name of the Qiskrypt's Classical Agent.
        """

        super().__init__(classical_agent_num, classical_agent_name,
                         POSSIBLE_AGENT_CONTEXTS[3])
        """
