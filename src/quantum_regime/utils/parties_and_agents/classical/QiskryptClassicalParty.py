...
class QiskryptClassicalParty(QiskryptParty):
    """
    Object class for the Qiskrypt's Classical Party.
    """

    def __init__(self, classical_party_num: int, classical_party_name: str):
        """
        Constructor of the Qiskrypt's Classical Party.

        :param classical_party_num: the number of the Qiskrypt's Classical Party.
        :param classical_party_name: the name of the Qiskrypt's Classical Party.
        """

        super().__init__(classical_party_num, classical_party_name,
                         POSSIBLE_PARTY_CONTEXTS[3])
        """
