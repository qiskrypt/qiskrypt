...
class QiskryptQuantumParty(QiskryptParty):
    """
    Object class for the Qiskrypt's Quantum Party.
    """

    def __init__(self, quantum_party_num: int, quantum_party_name: str):
        """
        Constructor of the Qiskrypt's Quantum Party.

        :param quantum_party_num: the number of the Qiskrypt's Quantum Party.
        :param quantum_party_name: the name of the Qiskrypt's Quantum Party.
        """

        super().__init__(quantum_party_num, quantum_party_name,
                         POSSIBLE_PARTY_CONTEXTS[0])
        """
