...
class QiskryptQuantumAgent(QiskryptAgent):
    """
    Object class for the Qiskrypt's Quantum Agent.
    """

    def __init__(self, quantum_agent_num: int, quantum_agent_name: str):
        """
        Constructor of the Qiskrypt's Quantum Agent.

        :param quantum_agent_num: the number of the Qiskrypt's Quantum Agent.
        :param quantum_agent_name: the name of the Qiskrypt's Quantum Agent.
        """

        super().__init__(quantum_agent_num, quantum_agent_name,
                         POSSIBLE_AGENT_CONTEXTS[0])
        """
