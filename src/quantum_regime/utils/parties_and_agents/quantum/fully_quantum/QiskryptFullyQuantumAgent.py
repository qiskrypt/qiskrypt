...
class QiskryptFullyQuantumAgent(QiskryptAgent):
    """
    Object class for the Qiskrypt's Fully-Quantum Agent.
    """

    def __init__(self, fully_quantum_agent_num: int, fully_quantum_agent_name: str):
        """
        Constructor of the Qiskrypt's Fully-Quantum Agent.

        :param fully_quantum_agent_num: the number of the Qiskrypt's Fully-Quantum Agent.
        :param fully_quantum_agent_name: the name of the Qiskrypt's Fully-Quantum Agent.
        """

        super().__init__(fully_quantum_agent_num, fully_quantum_agent_name,
                         POSSIBLE_AGENT_CONTEXTS[1])
        """
