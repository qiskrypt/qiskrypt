...
class QiskryptFullyQuantumParty(QiskryptParty):
    """
    Object class for the Qiskrypt's Fully-Quantum Party.
    """

    def __init__(self, fully_quantum_party_num: int, fully_quantum_party_name: str):
        """
        Constructor of the Qiskrypt's Fully-Quantum Party.

        :param fully_quantum_party_num: the number of the Qiskrypt's Fully-Quantum Party.
        :param fully_quantum_party_name: the name of the Qiskrypt's Fully-Quantum Party.
        """

        super().__init__(fully_quantum_party_num, fully_quantum_party_name,
                         POSSIBLE_PARTY_CONTEXTS[1])
        """
