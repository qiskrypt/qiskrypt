...
class QiskryptFullyQuantumRegisterTests(TestCase):
    ...
    def test_no_1_qiskrypt_fully_quantum_register_1_qubit(self):
        """
        Test Case #1:

        - Create a Qiskrypt's Fully-Quantum Register, with 1 qubit.
        ...
        """
        Assertion for the name of the Qiskrypt's Fully-Quantum Register.
        """

        assert(fully_quantum_register_num_qubits == qiskrypt_fully_quantum_register.get_num_qubits())
        """
        ...
        """
        Assertion for the own Qiskrypt's Fully-Quantum Register, regarding a Qiskrypt's Quantum Register.
        """

        assert(isinstance(qiskrypt_fully_quantum_register, QiskryptFullyQuantumRegister))
        """
        Assertion for the own Qiskrypt's Fully-Quantum Register, regarding a Qiskrypt's Fully-Quantum Register.
        """

        assert(not isinstance(qiskrypt_fully_quantum_register, QiskryptSemiQuantumRegister))
        """
        Assertion for the own Qiskrypt's Fully-Quantum Register, regarding a Qiskrypt's Semi-Quantum Register.
        """
    ...
    def test_no_2_qiskrypt_fully_quantum_register_2_qubits(self):
        """
        Test Case #2:

        - Create a Qiskrypt's Fully-Quantum Register, with 2 qubits.
        ...
        fully_quantum_register_num_qubits = 2
        """
        Set the number of qubits for the Qiskrypt's Fully-Quantum Register.
        """
    ...
    def test_no_3_qiskrypt_fully_quantum_register_4_qubits(self):
        """
        Test Case #3:

        - Create a Qiskrypt's Fully-Quantum Register, with 4 qubits.
        ...
        fully_quantum_register_num_qubits = 4
        """
        Set the number of qubits for the Qiskrypt's Fully-Quantum Register.
        """
    ...
    def test_no_4_qiskrypt_fully_quantum_register_8_qubits(self):
        """
        Test Case #4:

        - Create a Qiskrypt's Fully-Quantum Register, with 8 qubits.
        ...
        fully_quantum_register_num_qubits = 8
        """
        Set the number of qubits for the Qiskrypt's Fully-Quantum Register.
        """
...
if __name__ == "__main__":
    ...
    qiskrypt_fully_quantum_register_test_cases = \
        TestLoader().loadTestsFromTestCase(QiskryptFullyQuantumRegisterTests)
    """
    Load the Test Cases from the Unitary Tests for the Qiskrypt's Fully-Quantum Register.
    """

    qiskrypt_fully_quantum_register_test_suite = \
        TestSuite([qiskrypt_fully_quantum_register_test_cases])
    """
    Load the Test Suite with the Test Cases for the Qiskrypt's Fully-Quantum Register.
    """
