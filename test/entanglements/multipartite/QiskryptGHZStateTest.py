...
class QiskryptGHZStateTests(TestCase):
    ...
    def test_no_1_prepare_qiskrypt_ghz_state_3_qubits(self):
        """
        Test Case #1:
        ...
        qiskrypt_quantum_circuit_ghz_state_3_qubits_1.configure(0, [0, 0],
                                                                0, [1, 2])
        """
        ...
        final_quantum_state_vector_state = \
            execute(qiskrypt_quantum_circuit_ghz_state_3_qubits_1.qiskrypt_quantum_circuit.qiskit_quantum_circuit,
    ...
    def test_no_2_prepare_qiskrypt_ghz_state_4_qubits(self):
        """
        Test Case #2:
        ...
        qiskrypt_quantum_circuit_ghz_state_4_qubits_1 = \
            QiskryptQuantumCircuit(name=quantum_circuit_name,
                                   qiskrypt_quantum_registers=[qiskrypt_quantum_register],
                                   qiskrypt_fully_quantum_registers=None,
                                   qiskrypt_semi_quantum_registers=None,
        ...
        qiskrypt_quantum_circuit_ghz_state_4_qubits_1 = \
            QiskryptGHZState("ghz_state_4_qubits_1",
                             qiskrypt_quantum_circuit_ghz_state_4_qubits_1)
        """
        ...
        qiskrypt_quantum_circuit_ghz_state_4_qubits_1.configure(0, [0, 0, 0],
                                                                0, [1, 2, 3])
        """
        Configure the Qiskrypt's GHZ State, regarding its control IBM Qiskit's Quantum Register
        and control qubit, as well, its target IBM Qiskit's Quantum Registers and target qubits.
        ...
        final_quantum_state_vector_state = \
            execute(qiskrypt_quantum_circuit_ghz_state_4_qubits_1.qiskrypt_quantum_circuit.qiskit_quantum_circuit,
                    qiskit_state_vector_backend).result().get_statevector()
        """
        Execute the IBM Qiskit's Quantum Circuit of the Qiskrypt's Quantum Circuit
        and store the resulted quantum state represented in a final state vector.
    ...
    def test_no_3_prepare_qiskrypt_ghz_state_5_qubits(self):
        """
        Test Case #3:
        ...
        qiskrypt_quantum_circuit_ghz_state_5_qubits_1 = \
            QiskryptGHZState("ghz_state_5_qubits_1",
                             qiskrypt_quantum_circuit_ghz_state_5_qubits_1)
        """
        ...
        qiskrypt_quantum_circuit_ghz_state_5_qubits_1.configure(0, [0, 0, 0, 0],
                                                                0, [1, 2, 3, 4])
        """
        Configure the Qiskrypt's GHZ State, regarding its control IBM Qiskit's Quantum Register
        and control qubit, as well, its target IBM Qiskit's Quantum Registers and target qubits.
        ...
        final_quantum_state_vector_state = \
            execute(qiskrypt_quantum_circuit_ghz_state_5_qubits_1.qiskrypt_quantum_circuit.qiskit_quantum_circuit,
                    qiskit_state_vector_backend).result().get_statevector()
        """
        Execute the IBM Qiskit's Quantum Circuit of the Qiskrypt's Quantum Circuit
        and store the resulted quantum state represented in a final state vector.
    ...
    def test_no_4_prepare_qiskrypt_ghz_state_6_qubits(self):
        """
        Test Case #4:
        ...
        qiskrypt_quantum_circuit_ghz_state_6_qubits_1 = \
            QiskryptQuantumCircuit(name=quantum_circuit_name,
                                   qiskrypt_quantum_registers=[qiskrypt_quantum_register],
                                   qiskrypt_fully_quantum_registers=None,
                                   qiskrypt_semi_quantum_registers=None,
        ...
        qiskrypt_quantum_circuit_ghz_state_6_qubits_1 = \
            QiskryptGHZState("ghz_state_6_qubits_1",
                             qiskrypt_quantum_circuit_ghz_state_6_qubits_1)
        """
        ...
        qiskrypt_quantum_circuit_ghz_state_6_qubits_1.configure(0, [0, 0, 0, 0, 0],
                                                                0, [1, 2, 3, 4, 5])
        """
        Configure the Qiskrypt's GHZ State, regarding its control IBM Qiskit's Quantum Register
        and control qubit, as well, its target IBM Qiskit's Quantum Registers and target qubits.
        ...
        final_quantum_state_vector_state = \
            execute(qiskrypt_quantum_circuit_ghz_state_6_qubits_1.qiskrypt_quantum_circuit.qiskit_quantum_circuit,
                    qiskit_state_vector_backend).result().get_statevector()
        """
        Execute the IBM Qiskit's Quantum Circuit of the Qiskrypt's Quantum Circuit
        and store the resulted quantum state represented in a final state vector.
