...
class QiskryptBellStateTests(TestCase):
    ...
    def test_no_1_prepare_qiskrypt_bell_state_phi_plus_epr_pair(self):
        ...
        qiskrypt_bell_state = \
            QiskryptBellState("bell_state_phi_plus_epr_pair_1", qiskrypt_quantum_circuit,
    ...
    def test_no_2_prepare_qiskrypt_bell_state_phi_minus(self):
        ...
        qiskrypt_bell_state = \
            QiskryptBellState("bell_state_phi_minus_2", qiskrypt_quantum_circuit,
    ...
    def test_no_3_prepare_qiskrypt_bell_state_phi_plus_epr_pair(self):
        ...
        qiskrypt_bell_state = \
            QiskryptBellState("bell_state_psi_plus_3", qiskrypt_quantum_circuit,
    ...
    def test_no_4_prepare_qiskrypt_bell_state_psi_minus(self):
        ...
        qiskrypt_bell_state = \
            QiskryptBellState("bell_state_psi_minus_4", qiskrypt_quantum_circuit,
